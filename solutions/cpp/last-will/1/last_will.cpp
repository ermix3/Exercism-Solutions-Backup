...
namespace estate_executor{
    ...
    int assemble_code(){
        int code = 0;
        code += zhang::red::code_fragment();
        code += khan::red::code_fragment();
        code += garcia::red::code_fragment();
        code += zhang::blue::code_fragment();
        code += khan::blue::code_fragment();
        code += garcia::blue::code_fragment();
        return code;
    }
}